...
from common.utils import send_message, get_message, encode_to_bytes, decode_to_dict
...
class TestUtils(unittest.TestCase):
    ...
    # def test_encode_to_bytes_err(self):
    #     self.assertRaises(TypeError, encode_to_bytes, 'some wrong message')

    # def test_decode_to_dict(self):
    #     self.assertRaises(TypeError, decode_to_dict, 'some wrong message')
